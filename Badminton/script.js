...
submitBtn.addEventListener('click', function() {
    const correctAnswersList = ['c', 'b', 'a', 'b', 'c'];
...
function displayResults() {
    ...
    const totalTimeTaken = Math.floor((timeEnd - timeStart) / 1000); 
...
function updateTimer(seconds) {
    ...
    document.querySelector('.timer').textContent = formattedTime; // Update timer display
}
